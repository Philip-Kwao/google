...
const Footer = () => {
  return (
    <div className='mb-0 bg-stone-100 h-[100px] w-full absolute bottom-0 flex flex-col items-left justify-around px-4 overflow-x-hidden'>
        <div className="text-sm opacity-50 ml-4">Ghana</div>
        <span className='h-[0.5px] opacity-25 w-full absolute bg-gray-400 top-12'></span>
